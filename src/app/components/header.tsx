      ...
      <div className="pb-12 pt-2 h-[41rem] w-full bg-white bg-grid-black/[0.1] relative flex items-center justify-center">
        ...
        <div className="gap-8 max-[800px]:flex-col flex justify-between">
          <div className="flex flex-col justify-center items-center gap-0">
            ...
            <Link
              className=" w-[25rem] border-2 border-black bo flex h-10 items-center justify-center rounded-lg bg-gradient-to-b from-purple-200 to-purple-400 hover:bg-purple-500 px-20 mt-6 py-8 text-xl transition-colors"

      ...
      <div className="container space-y-12 px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-1">
            <h2 className="text-3xl text-purple-500 font-bold tracking-tighter md:text-5xl pb-4">
            ...
            const featureInfo = (
              <div key={index} className="flex flex-col gap-2 ">
                <div className="font-semibold flex justify-start gap-4 items-center">
                  {feature.icon("h-12 w-12 text-purple-500")}
                  <h3 className="sm:text-l md:text-2xl lg:text-3xl text-purple-500 font-semibold">
                    {feature.heading}
                  </h3>
                </div>
